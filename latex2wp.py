'''
New Branch:
    Ok, I am totally sick of trying to do a simple modification and finding
    out that he has deleted the new-lines already. I am re-doing this whole
    module from (practically) scratch. 
    
    It is REALLY simple -- in fact I already have most of what I need.
    
    It is no longer going to support math (yet), but the code base will be
    alot more sane.
