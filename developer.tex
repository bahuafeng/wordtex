...
\section{Wordtex -- The Latex Publishing Software for Python}
...
and tries to convert them to TexPart objects. This happens through
two functions:
\begin{enumerate}
...
This is the main module for wordtex. The primary class is TexPart,
...
an example on how to do this.\end{enumerate}
